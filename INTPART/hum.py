...
plt.plot(totaltemps,linewidth=2,color='m',zorder=2)   

plt.xlim([0,len(totaltemps)])
plt.ylim([0,100])

perc = r'$\bf{\%}$'
fig.suptitle(r'\textbf{Humidity \textbf{%s}' % (perc),fontsize=13)   
        
plt.savefig(directoryfigure + 'hum.png',dpi=300)                     